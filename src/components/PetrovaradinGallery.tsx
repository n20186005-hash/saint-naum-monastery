...
const photos = [
  { src: '/gallery/images (1).jpg', alt: 'petrovaradin_gallery_1' },
  { src: '/gallery/images (2).jpg', alt: 'petrovaradin_gallery_2' },
  { src: '/gallery/images (3).jpg', alt: 'petrovaradin_gallery_3' },
  { src: '/gallery/images (4).jpg', alt: 'petrovaradin_gallery_4' },
  { src: '/gallery/images (5).jpg', alt: 'petrovaradin_gallery_5' },
  { src: '/gallery/images (6).jpg', alt: 'petrovaradin_gallery_6' },
  { src: '/gallery/images (7).jpg', alt: 'petrovaradin_gallery_7' },
  { src: '/gallery/images (8).jpg', alt: 'petrovaradin_gallery_8' },
  { src: '/gallery/images (9).jpg', alt: 'petrovaradin_gallery_9' },
  { src: '/gallery/images (10).jpg', alt: 'petrovaradin_gallery_10' },
  { src: '/gallery/images (11).jpg', alt: 'petrovaradin_gallery_11' },
  { src: '/gallery/images (12).jpg', alt: 'petrovaradin_gallery_12' },
  { src: '/gallery/images (13).jpg', alt: 'petrovaradin_gallery_13' },
  { src: '/gallery/images (14).jpg', alt: 'petrovaradin_gallery_14' },
];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
              {photos.slice(currentPage * ITEMS_PER_PAGE, (currentPage + 1) * ITEMS_PER_PAGE).map((photo, i) => {
